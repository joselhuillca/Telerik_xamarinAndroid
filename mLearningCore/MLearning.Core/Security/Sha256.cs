...
namespace Sha2
{
    public class Sha256
    {
        ...
        public ICollection<byte> GetHash()
        {
        ...
        public UInt32[] GetHashUInt32()
        {
            ...
            UInt32[] array = new UInt32[H.Length];
            H.CopyTo(array, 0);
            return array;
        }
        ...
        private static ICollection<byte> toByteArray(UInt32 []src)
        {
        ...
        public static ICollection<byte> HashFile(Stream fs)
        {
        ...
        public static string ArrayToString(IList<byte> arr)
        {
